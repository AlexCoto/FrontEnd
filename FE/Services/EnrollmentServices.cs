    ...
    public class EnrollmentServices : IEnrollmentServices
    {
        public void Delete(Enrollment t)
        {
            try
            {
                using (var cl = new HttpClient())
                {
                    ...
                    HttpResponseMessage res = cl.DeleteAsync("api/Enrollment/" + t.EnrollmentId.ToString()).Result;
        ...
        public IEnumerable<Enrollment> GetAll()
        {
            ...
            using (var cl = new HttpClient())
            {
                ...
                cl.DefaultRequestHeaders.Clear();
                cl.DefaultRequestHeaders.Accept.Add(new System.Net.Http.Headers.MediaTypeWithQualityHeaderValue("application/json"));
                HttpResponseMessage res = cl.GetAsync("api/Enrollment").Result;
        ...
        public async Task<IEnumerable<Enrollment>> GetAllAsync()
        {
            ...
            using (var cl = new HttpClient())
            {
                ...
                cl.DefaultRequestHeaders.Clear();
                cl.DefaultRequestHeaders.Accept.Add(new System.Net.Http.Headers.MediaTypeWithQualityHeaderValue("application/json"));
                HttpResponseMessage res = await cl.GetAsync("api/Enrollment");
        ...
        public Enrollment GetOneById(int id)
        {
            ...
            using (var cl = new HttpClient())
            {
                ...
                cl.DefaultRequestHeaders.Clear();
                cl.DefaultRequestHeaders.Accept.Add(new System.Net.Http.Headers.MediaTypeWithQualityHeaderValue("application/json"));
                HttpResponseMessage res = cl.GetAsync("api/Enrollment/" + id).Result;
        ...
        public async Task<Enrollment> GetOneByIdAsync(int id)
        {
            ...
            using (var cl = new HttpClient())
            {
                ...
                cl.DefaultRequestHeaders.Clear();
                cl.DefaultRequestHeaders.Accept.Add(new System.Net.Http.Headers.MediaTypeWithQualityHeaderValue("application/json"));
                HttpResponseMessage res = await cl.GetAsync("api/Enrollment/" + id);
        ...
        public void Insert(Enrollment t)
        {
            try
            {
                using (var cl = new HttpClient())
                {
                    ...
                    var postTask = cl.PostAsync("api/Enrollment", byteContent).Result;
        ...
        public void Update(Enrollment t)
        {
            try
            {
                using (var cl = new HttpClient())
                {
                    ...
                    var byteContent = new ByteArrayContent(buffer);
                    byteContent.Headers.ContentType = new System.Net.Http.Headers.MediaTypeHeaderValue("application/json");
                    var postTask = cl.PutAsync("api/Enrollment/" + t.EnrollmentId, byteContent).Result;

    ...
    public class DepartmentServices : IDepartmentServices
    {
        public void Delete(Department t)
        {
            try
            {
                using (var cl = new HttpClient())
                {
                    ...
                    HttpResponseMessage res = cl.DeleteAsync("api/Department/" + t.DepartmentId.ToString()).Result;
        ...
        public IEnumerable<Department> GetAll()
        {
            ...
            using (var cl = new HttpClient())
            {
                ...
                cl.DefaultRequestHeaders.Clear();
                cl.DefaultRequestHeaders.Accept.Add(new System.Net.Http.Headers.MediaTypeWithQualityHeaderValue("application/json"));
                HttpResponseMessage res = cl.GetAsync("api/Department").Result;
        ...
        public async Task<IEnumerable<Department>> GetAllAsync()
        {
            ...
            using (var cl = new HttpClient())
            {
                ...
                cl.DefaultRequestHeaders.Clear();
                cl.DefaultRequestHeaders.Accept.Add(new System.Net.Http.Headers.MediaTypeWithQualityHeaderValue("application/json"));
                HttpResponseMessage res = await cl.GetAsync("api/Department");
        ...
        public async Task<Department> GetOneByIdAsync(int id)
        {
            ...
            using (var cl = new HttpClient())
            {
                ...
                cl.DefaultRequestHeaders.Clear();
                cl.DefaultRequestHeaders.Accept.Add(new System.Net.Http.Headers.MediaTypeWithQualityHeaderValue("application/json"));
                HttpResponseMessage res = await cl.GetAsync("api/Department/" + id);
        ...
        public void Insert(Department t)
        {
            try
            {
                using (var cl = new HttpClient())
                {
                    ...
                    var postTask = cl.PostAsync("api/Department", byteContent).Result;
        ...
        public void Update(Department t)
        {
            try
            {
                using (var cl = new HttpClient())
                {
                    ...
                    var byteContent = new ByteArrayContent(buffer);
                    byteContent.Headers.ContentType = new System.Net.Http.Headers.MediaTypeHeaderValue("application/json");
                    var postTask = cl.PutAsync("api/Department/" + t.DepartmentId, byteContent).Result;
